...
1. Вынес fetchTodos в отдельный custom hook - useTodos
2. Удалил completedCount из состояния (Теперь вычисляется на основе состояния todos)
3. Исправил зависимость эффекта useEffect
4. class -> className
